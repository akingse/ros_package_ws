...
(cl:ensure-generic-function 'start_asap-val :lambda-list '(m))
(cl:defmethod start_asap-val ((m <SwitchController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller_manager_msgs-srv:start_asap-val is deprecated.  Use controller_manager_msgs-srv:start_asap instead.")
  (start_asap m))

(cl:ensure-generic-function 'timeout-val :lambda-list '(m))
(cl:defmethod timeout-val ((m <SwitchController-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller_manager_msgs-srv:timeout-val is deprecated.  Use controller_manager_msgs-srv:timeout instead.")
  (timeout m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SwitchController-request>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'start_asap) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SwitchController-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'stop_controllers)))
    ...
    (cl:setf (cl:slot-value msg 'start_asap) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SwitchController-request>)))
  ...
  "b29a7abc673b2c54c14b54e50f8d06a5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SwitchController-request)))
  "Returns md5sum for a message object of type 'SwitchController-request"
  "b29a7abc673b2c54c14b54e50f8d06a5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SwitchController-request>)))
  ...
  (cl:format cl:nil "~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%string[] start_controllers~%string[] stop_controllers~%int32 strictness~%int32 BEST_EFFORT=1~%int32 STRICT=2~%bool start_asap~%float64 timeout~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SwitchController-request)))
  "Returns full string definition for message of type 'SwitchController-request"
  (cl:format cl:nil "~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%~%string[] start_controllers~%string[] stop_controllers~%int32 strictness~%int32 BEST_EFFORT=1~%int32 STRICT=2~%bool start_asap~%float64 timeout~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SwitchController-request>))
  ...
  (cl:list 'SwitchController-request
    ...
    (cl:cons ':start_asap (start_asap msg))
